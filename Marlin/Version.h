 ...
 */
   ...
   */
  #define SHORT_BUILD_VERSION "Version 1.0.0"
   ...
   */
  #define MACHINE_NAME "MX-m Series"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/hoangbinhc11996/sdls_firmware"
   ...
   */
  #define WEBSITE_URL "smartdesignlabs.com"
